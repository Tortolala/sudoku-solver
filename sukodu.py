...
def parse_puzzle(puzzle, digits='123456789', nulls='0.'):
	...
	# TODO: este flat puzzle es el array de izq a der y arri pa abj, ya casi lo tengo en el scriot original. 
	#       Solo traducir y alimantar desde aca.   
	print(flat_puzzle) 
...
def main():
	...
	---------+---------+---------
	 ...
	 .  9  . | .  .  . | 4  .  .
	"""
	display_grid(solve_puzzle(puzzle1))
